...
def TL():
    allurls = 'data3.csv'    #path to our all urls file
    ...
    lgs = RandomForestClassifier(n_estimators=1000,criterion='entropy',random_state=0,n_jobs=-1)    #using logistic regression
    lgs.fit(X_train, y_train)
    print(lgs.score(X_test, y_test))    #pring the score. It comes out to be 98%
    return vectorizer, lgs

@app.route('/https://stackoverflow.com/questions/3887381/typeerror-nonetype-object-is-not-iterable-in-python')
def show_index(path):
    X_predict = []
